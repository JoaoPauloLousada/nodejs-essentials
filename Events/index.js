...
emitter.emit('error', new Error('The error message'))
...
emitter.prependListener('tick', tick => console.log('Prepend tick', tick))
...
emitter.prependOnceListener('tick once', tick => console.log('Prepened tick once:', tick))
...
setTimeout(() => emitter.removeListener('remove', onRemoveListener), 100)
emitter.emit('remove')
